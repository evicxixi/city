# Generated by Django 2.1 on 2018-08-19 16:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(limit_choices_to=models.Q(_negated=True, course_type=2), on_delete=django.db.models.deletion.CASCADE, to='api.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor', models.ForeignKey(blank=True, limit_choices_to={'role': 1}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_students', to='api.Account', verbose_name='导师')),
            ],
            options={
        ...
        migrations.AlterModelOptions(
            name='coupon',
            options={'verbose_name_plural': '31. 优惠券'},
        ),
